	  ...
	  _createClass(CheckboxDemo, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        'div',
	        null,
	        React.createElement(_reactSelectlist.ReactSelectList, { data: data, defaultValue: selected, multiple: multiple, orientation: orientation, onChange: this._onSelectChange }),
	        React.createElement(
	          'div',
	          null,
	          'The selected value: ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if(true)
			module.exports = factory(__webpack_require__(2), __webpack_require__(33));
