...
/***/ function(module, exports, __webpack_require__) {
	...
	var CheckboxDemo = function (_React$Component) {
	  ...
	  function CheckboxDemo(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CheckboxDemo).call(this, props));

	    _this._onSelectChange = function (newSelect) {
	  ...
	  _createClass(CheckboxDemo, [{
	    ...
	    value: function render() {
	      ...
	      var orientation = _state.orientation;

	      return React.createElement(
	        'div',
	        null,
	        React.createElement(_reactSelectlist.ReactSelectList, { data: data, multiple: multiple, orientation: orientation, onChange: this._onSelectChange }),
	        React.createElement(
	          'div',
	          null,
	          'The selected value: ',
	        ...
	        React.createElement(
	          ...
	          React.createElement(_reactSelectlist.ReactSelectList, { id: 'multiple', data: [{ id: "true", name: "Mutiple" }, { id: "false", name: "Single" }], multiple: false, defaultValue: ["true"], onChange: this._onMultiple }),
	          React.createElement(_reactSelectlist.ReactSelectList, { id: 'orientation', data: [{ id: "vertical", name: "Vertical" }, { id: "horizontal", name: "Horizontal" }], multiple: false, defaultValue: ["horizontal"], onChange: this._onOrientation })
	        )
	      );
	    }
	  }]);
	...
	;
	ReactDOM.render(React.createElement(CheckboxDemo, null), document.getElementById('demo'));
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (/******/function (modules) {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				module.exports = {
					ReactSelectList: _reactSelectlist.ReactSelectList
				};
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var ReactSelectList = exports.ReactSelectList = function (_React$Component) {
					...
					function ReactSelectList(props) {
						...
						var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ReactSelectList).call(this, props));
						...
						value: function render() {
							...
							var row = data.map(function (item, index) {
								...
								if (orientation.toString().toLowerCase() == "horizontal") {
									return React.createElement('span', { key: index, style: customStyles, className: customCss }, React.createElement('input', { id: "select" + id + index, checked: selected[index], name: "select" + id + index, onChange: _this2._handleChange, type: selectType, value: value }), React.createElement('label', { htmlFor: "select" + id + index }, text));
								} else {
									return React.createElement('div', { key: index, style: customStyles, className: customCss }, React.createElement('input', { id: "select" + id + index, checked: selected[index], name: "select" + id + index, onChange: _this2._handleChange, type: selectType, value: value }), React.createElement('label', { htmlFor: "select" + id + index }, text));
								}
							});
